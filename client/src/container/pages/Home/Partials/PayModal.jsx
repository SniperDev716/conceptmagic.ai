...
function PayModal({ open, setOpen, price, planId, setSuccessful }) {
  ...
  return (
    <Modal
      ...
      width={460}
      title={<div className="text-center"><Title level={3} className="!mb-1">7 Day Free Trial</Title> <Title level={5} className="!m-0">Beta Pricing: Only ${price} / Month</Title></div>}
      open={open}
      centered
      footer={[]}
      maskClosable={false}
