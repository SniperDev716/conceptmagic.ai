...
function Home() {
  ...
  return (
    <Content className="text-center max-w-5xl mx-auto p-2 my-5">
      <Row>
        <Col span={24}>
          <h3 className="text-lg sm:text-xl md:text-2xl">We'll walk you through the first, and then let you explore your creativity. <br />Pick a category to start with.</h3>
        </Col>
        <Col span={24}>
          <Row gutter={[24, 24]}>
            {categories.map((cat, index) => <Col key={index} span={8}>
              <div className="text-center hover:-m-1">
                <Image preview={false} src={`/imgs/category/${cat.src}`} className="!w-full md:w-[80%] mx-auto bg-gray-300 cursor-pointer rounded shadow-sm hover:shadow-lg" onClick={() => handleNext(cat)} placeholder={<Image preview={false} src="data:image/png;base64," className="!w-full md:w-[80%]" />}></Image> <br />
